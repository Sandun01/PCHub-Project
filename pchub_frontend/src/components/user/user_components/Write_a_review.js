...
class Write_a_review extends Component {
  constructor(props) {
    super(props);
    this.state = {
      user: {
    ...
    return (
      <div style={{ margin: '30px 70px 30px 70px' }}>
        <Container>
          ...
          <br />
          <Typography>
            Hey, [customer name], thanks for being our customer! Please consider
            leaving us a review. [Review link].
          </Typography>
...
export default withStyles(styles)(Write_a_review);
